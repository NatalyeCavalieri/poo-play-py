...
#Heroi: herda do personagem - controlado pelo usuário
...
class Jogo:
    ...
    def __init__(self) -> None:
        self.heroi = Heroi(nome="Hulk", vida=100, nivel=5, habilidade="Super Força")
        self.inimigo = Inimigo(nome="Loki", vida=80, nivel=5, tipo="Voador")
